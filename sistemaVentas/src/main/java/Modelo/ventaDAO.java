...
public class ventaDAO {
    ...
    public ventaDAO(int id_cabecera_venta, String fecha_venta, int id_cliente, int id_empleado, int id_detalle_venta, int precio_venta, int cantida, int id_producto) {
