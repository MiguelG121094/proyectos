<%-- 
    ...
    Created on : 19/01/2023, 02:30:25 PM
    Author     : Miguel
--%>
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="listarEmpleado.jsp">Cliente</a></li>
                                <li><a class="dropdown-item" href="listarEmpleado.jsp">Empleado</a></li>
                                <li><a class="dropdown-item" href="agregarPersona.jsp">Proveedor</a></li>
                                <li><hr class="dropdown-divider"href="agregarPersona.jsp"></li>
        ...
        <div>
            ...
            <div class="container" style="min-height: 62vh">
                ...
                <form name="formCliente" action="clienteDTO?accion=agregar" method="POST">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="txtruc" name="txtruc" required="true">
                    </div>
                    <button type="submit" class="btn btn-primary">Guardar</button> <a href="javascript:window.history.back()">Volver a la página anterior</a>
                </form>
