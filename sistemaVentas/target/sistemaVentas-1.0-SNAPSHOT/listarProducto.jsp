<%-- 
    ...
    Created on : 19/01/2023, 08:18:03 PM
    Author     : Miguel
--%>
    ...
    <body>
        ...
        <div>
            ...
            <div class="container" style="min-height: 62vh">
                ...
                <div class="navbar">
                        <a href="agregarProducto.jsp" class="btn btn-outline-success">Agregar</a>
                            ...
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr class="bg-dark">
                                        ...
                                        <th class="text-center text-light">Cantidad minima en stock</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"><%= rs.getInt("cantidad_minima")%></td>
                                        <td class="text-center">
                                            <a href="productoDTO?id=<%= rs.getString("id_producto") %>&accion=editar_listar" class="btn btn-warning">Editar</a>
                                            <a href="productoDTO?id=<%= rs.getString("id_producto") %>&accion=eliminar" class="btn btn-danger" >Eliminar</a>
