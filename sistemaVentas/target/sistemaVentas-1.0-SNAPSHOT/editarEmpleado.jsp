<%-- 
    ...
    Created on : 19/01/2023, 11:31:41 AM
    Author     : Miguel
--%>
        ...
        <div>
            ...
            <div class="container" style="min-height: 62vh">
                ...
                <%
                    ...
                    while (rs.next()) {
                %>
                <form action="clienteDTO?accion=editar" method="POST">
                    <div class="mb-3">
                        <label class="form-label">Id del Empleado</label>
                        <input type="text" class="form-control" readonly="true" id="txtid" 
                               name="txtid" value="<%= rs.getInt("id_empleado")%>">
                    </div>
                    <div class="mb-3">
                        <label for="apellido" class="form-label">Nombre</label>
                        <input type="text" class="form-control" id="txtnombre" name="txtnombre" required="true" value="<%= rs.getString("nombre")%>">
                    </div>
                    <div class="mb-3">
                        <label for="apellido" class="form-label">Apellidos</label>
                        <input type="text" class="form-control" id="txtapellido" name="txtapellido" required="true" value="<%= rs.getString("apellido")%>">
                    </div>
                    <div class="mb-3">
                        <label for="cedula" class="form-label">Cedula</label>
                        <input type="text" class="form-control" id="txtcedula" name="txtcedula" required="true"value="<%= rs.getInt("ci")%>">
                    </div>
                    <div class="mb-3">
                        <label for="direccion" class="form-label">Direccion</label>
                        <input type="text" class="form-control" id="txtdireccion" name="txtdireccion" required="true" value="<%= rs.getString("direccion")%>">
                    </div>
                    <div class="mb-3">
                        <label for="telefono" class="form-label">Telefono</label>
                        <input type="text" class="form-control" id="txttelefono" name="txttelefono" required="true" value="<%= rs.getString("telefono")%>">
                    </div>
                    <div class="mb-3">
                        <label for="nombre" class="form-label">Usuario</label>
                        <input type="text" class="form-control" id="txtusuario" name="txtusuario" required="true" value="<%= rs.getString("usuario")%>">
                    </div>
                    <div class="mb-3">
                        <label for="apellido" class="form-label">Clave</label>
                        <input type="password" class="form-control" id="txtclave" name="txtclave" required="true" value="<%= rs.getString("clave")%>">
                    </div>
                    <div class="mb-3">
