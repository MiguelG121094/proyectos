<%-- 
    ...
    Created on : 16/01/2023, 08:18:54 PM
    Author     : Miguel
--%>
        ...
        <div>
            <main>
                ...
                <div class="container" style="min-height: 62vh">
                    <div class="navbar">
                        <a href="agregarEmpleado.jsp" class="btn btn-outline-success">Agregar</a>
                        ...
                        <div class="row">
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    %>
                                    <tr>
                                        <td class="text-center"><%= rs.getInt("id_empleado")%></td>
                                        ...
                                        <td class="text-center">
                                            <a href="empleadoDTO?id=<%= rs.getString("id_empleado") %>&accion=editar_listar" class="btn btn-warning">Editar</a>
                                            <a href="empleadoDTO?id=<%= rs.getString("id_empleado") %>&accion=eliminar" class="btn btn-danger" >Eliminar</a>
