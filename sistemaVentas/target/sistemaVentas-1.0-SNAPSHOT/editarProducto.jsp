<%-- 
    ...
    Created on : 20/01/2023, 12:30:47 AM
    Author     : Miguel
--%>
        ...
        <div>
            ...
            <div class="container" style="min-height: 62vh">
                ...
                <%
                    while (rs.next()) {
                %>
                <form name="formProveedor" action="productoDTO?accion=editar" method="POST">
                    <div class="mb-3">
                        <label class="form-label">Id del Producto</label>
                        <input type="text" class="form-control" readonly="true" id="txtid" 
                               name="txtid" value="<%= rs.getInt("id_producto")%>">
                    </div>
                    <div class="mb-3">
                        <label for="nombre" class="form-label">Descripcion</label>
                        <input type="text" class="form-control" id="txtdescripcion" name="txtdescripcion" required="true" value="<%= rs.getString("descripcion")%>">
                    </div>
                    <div class="mb-3">
                        <label for="apellido" class="form-label">Precio de compra</label>
                        <input type="text" class="form-control" id="txtprecio_compra" name="txtprecio_compra" required="true" value="<%= rs.getInt("pro_precio_compra")%>">
                    </div>
                    <div class="mb-3">
                        <label for="cedula" class="form-label">Precio de venta</label>
                        <input type="text" class="form-control" id="txtprecio_venta" name="txtprecio_venta" required="true" value="<%= rs.getInt("pro_precio_venta")%>">
                    </div>
                    <div class="mb-3">
                        <label for="direccion" class="form-label">Cantidad minima</label>
                        <input type="text" class="form-control" id="txtcantidad_minima" name="txtcantidad_minima" required="true" value="<%= rs.getInt("cantidad_minima")%>">
                    </div>
