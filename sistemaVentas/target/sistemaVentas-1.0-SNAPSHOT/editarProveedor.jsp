<%-- 
    ...
    Created on : 19/01/2023, 04:53:52 PM
    Author     : Miguel
--%>
            ...
            <div class="container" style="min-height: 62vh">
                ...
                <form action="proveedorDTO?accion=editar" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="txtruc" name="txtruc" required="true" value="<%= rs.getString("ruc")%>">
                    </div>
