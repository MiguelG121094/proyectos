<%-- 
    ...
    Created on : 22/01/2023, 02:31:30 PM
    Author     : Miguel
--%>
    ...
    <body>
        ...
        <div>
            ...
            <div class="container" style="min-height: 62vh">
                ...
                <div class="navbar">
                        <a href="" class="btn btn-outline-success">Generar Venta</a>
                    ...
                    <div class="container text-capitalize">
                        ...
                        <div class="row">
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr class="bg-dark">
                                        <th class="text-center text-light">Nro de Factura</th>
                                        <th class="text-center text-light">Fecha de Venta</th>
                                ...
                                <tbody>
                                    ...
                                    %>
                                    <tr>
                                        <td class="text-center"><%= rs.getInt("id_cab_venta")%></td>
                                        <td class="text-center"><%= rs.getDate("fecha_venta")%></td>
                                        <td class="text-center"><%= rs.getString("nombre")%></td>
                                        <td class="text-center"><%= rs.getString("ruc")%></td>
                                        <td class="text-center"><%= rs.getString("descripcion")%></td>
                                        <td class="text-center"><%= rs.getInt("precio_venta")%></td>
                                        <td class="text-center"><%= rs.getInt("cantidad")%></td>
                                        <td class="text-center"><%= rs.getInt("subtotal")%></td>
                                        <td class="text-center">
                                            <a href="" class="btn btn-warning">Editar</a>
                                            <a href="" class="btn btn-danger" >Estado</a>
