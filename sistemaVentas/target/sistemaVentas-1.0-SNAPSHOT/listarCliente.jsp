<%-- 
    ...
    Created on : 18/01/2023, 02:39:24 PM
    Author     : Miguel
--%>
        ...
        <div>
            <main>
                ...
                <div class="container" style="min-height: 62vh">
                    <div class="navbar">
                        <a href="agregarCliente.jsp" class="btn btn-outline-success">Agregar</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="clienteDTO?id=<%= rs.getString("id_cliente") %>&accion=editar_listar" class="btn btn-warning">Editar</a>
                                            <a href="clienteDTO?id=<%= rs.getString("id_cliente") %>&accion=eliminar" class="btn btn-danger" >Eliminar</a>
