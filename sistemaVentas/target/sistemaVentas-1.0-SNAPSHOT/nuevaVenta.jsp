    ...
    <body>
        ...
        <div>
            ...
            <div style="min-height: 62vh">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="ventaDTO?id_cliente=<%= rs.getString("id_cliente")%>&accion=cargar_cliente" class="btn btn-primary">Seleccionar</a>
                ...
                <%
                    ResultSet rs3 = null;
                    if (request.getAttribute("datosCliente_id") != null) {
                        rs3 = (ResultSet) request.getAttribute("datosCliente_id");
                    }

                    ResultSet rs4 = null;
                    if (request.getAttribute("datosProducto_id") != null) {
                        rs3 = (ResultSet) request.getAttribute("datosProducto_id");
                    }
                %>
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="col-sm-6 d-flex">
                                            ...
                                            <%
                                                if (request.getAttribute("datosCliente_id") != null) {
                                                    ...
                                                    while (rs3.next()) {
                                            %>
                                            <input type="text" name="txtidCliente" id="txtidCliente" value="<%= rs3.getInt("id_cliente")%>" class="form-control" disabled="true" placeholder="Id del Cliente">
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="text" name="nombreCliente" class="form-control" value="<%= rs3.getString("nombre")%>" disabled="true" placeholder="Nombre del Cliente">
                                ...
                                <div class="form-group d-flex">
                                    <div class="col-sm-6 d-flex">
                                        ...
                                        <input type="text" name="txtidProducto" class="form-control" readonly="true" placeholder="Id del Producto">

                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" value="" name="txtnombreProducto" class="form-control" readonly="true" placeholder="Descripcion">
                                    </div>
                                </div>
                                <div class="form-group d-flex">
                                    <div class="form-group d-flex">
                                        <div class="col-sm-7 d-flex">
                                            <input type="text" name="txtprecio" class="form-control" readonly="true" placeholder="Precio">
                                        </div>
                                        <div class="col-sm-6">   
