...
public class conexion_postgresql {
    ...
    String puerto = "5432";
    String usuario = "postgres"; //usuario del postgres
    String password = "adolfo94"; // tu contraseña
    String basedatos = "bd_pruebas"; //nombre de tu DB
    String local;
    ...
    public void conectar() throws Exception {
        ...
        String cadenaconexion = "jdbc:postgresql://" + servidor + ":" + puerto + "/" + basedatos;
